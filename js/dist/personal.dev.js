      ...
      if (e.target.type === 'checkbox') {
        ...
        if (parentCheckboxMain) {
          ...
          if (e.target.checked) {
            ...
            var childCheckboxes = parentCheckboxMain.closest('.checkbox.list').querySelectorAll('.search__more-name');
            childCheckboxes.forEach(function (childCheckbox) {
              var childLabel = childCheckbox.textContent; // Добавляем HTML-код выбранного элемента

              searchSelectedBox.innerHTML += "\n                            <div class=\"search__selected-item\">\n                                <div class=\"checkbox searchSelected\">\n                                    <input type=\"checkbox\">\n                                    <label for=\"\">".concat(childLabel, "</label>\n                                    <img src=\"/img/register/btn-close.svg\" alt=\"x\">\n                                </div>\n                            </div>\n                            ");
            });
          } else {
            ...
            var parentLabel = parentCheckboxMain.closest('.checkbox.list').querySelectorAll('.search__item-more .item .checkbox label');
            var parentLabels = [];
            parentLabel.forEach(function (e) {
